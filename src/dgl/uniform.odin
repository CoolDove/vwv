...
uniform_get_location :: proc(shader: ShaderId, name: cstring) -> UniformLoc {
...
uniform_set_mat4x4 :: proc(uniform : UniformLocMat4x4, mat: linalg.Matrix4x4f32) {
	if uniform == -1 do return
	mat := mat
	gl.UniformMatrix4fv(uniform, 1, false, auto_cast &mat)
}
