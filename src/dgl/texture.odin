...
image_from_mem_png :: proc(data: []byte) -> Image {
	width, height, channels : libc.int
...
texture_load :: proc {
	...
	texture_load_from_mem_png,
}

texture_load_from_mem_png :: proc(data: []byte, gen_mipmap := false) -> Texture {
	img := image_from_mem_png(data)
